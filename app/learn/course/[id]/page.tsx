                            ...
                            <>
                                ...
                                <div className="grid md:grid-cols-2 gap-8">
                                    ...
                                    <div className="bg-white border-4 border-black p-6 shadow-[4px_4px_0_rgba(0,0,0,1)] flex flex-col items-center justify-center text-center space-y-4">
                                        ...
                                        <div className="flex w-full gap-4 pt-4 border-t-2 border-gray-100 mt-4">
                                            {prevLesson ? (
                                                <Button
                                                    onClick={() => setCurrentLesson(prevLesson)}
                                                    variant="outline"
                                                    className="flex-1 bg-white text-ink-black border-2 border-black uppercase font-bold hover:bg-gray-100 shadow-[2px_2px_0_rgba(0,0,0,1)] hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-none transition-all"
                                                >
                                            ...
                                            {nextLesson ? (
                                                <Button
                                                    ...
                                                    variant="outline"
                                                    className="flex-1 bg-ink-black text-white border-2 border-black uppercase font-bold hover:bg-gray-900 shadow-[2px_2px_0_rgba(0,0,0,1)] hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-none transition-all"
                                                >
                                                    Next
