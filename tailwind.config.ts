  ...
  theme: {
    ...
    extend: {
      screens: {
        ...
        'xl': '1280px',
        '2xl': '1400px',
        // Height-based breakpoints for landscape phones
        'short': { 'raw': '(max-height: 600px)' },
        'tall': { 'raw': '(min-height: 800px)' },
      },
      fontFamily: {
        sans: ["var(--font-kanit)", "var(--font-inter)", "ui-sans-serif", "system-ui", "-apple-system", "BlinkMacSystemFont", "Segoe UI", "Roboto", "sans-serif"],
      ...
      boxShadow: {
        ...
        "mobile-lg": "0 4px 6px -1px rgba(0, 0, 0, 0.1)",
      },
      spacing: {
        // Safe area insets
      ...
      fontSize: {
        ...
        'fluid-3xl': ['clamp(1.875rem, 1.6rem + 1.375vw, 2.5rem)', { lineHeight: '1.1' }],
